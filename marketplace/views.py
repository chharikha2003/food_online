        ...
        if request.headers.get('x-requested-with') == 'XMLHttpRequest':
           #check if food item exists
            try:
               ...
               #check if user already added item to cart
               try:
                   ...
                   return JsonResponse({'status':'Success','message':'Added Fooditem to cart','cart_counter':get_cart_counter(request),'qty':chkCart.quantity,'cart_amount':get_cart_amounts(request)})
            except:
